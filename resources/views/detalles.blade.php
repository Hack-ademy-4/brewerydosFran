            ...
            <div class="col-12 col-md-6 mb-5">
                ...
                <div class="member">
                    ...
                    <div class="member-info">
                        <h5 class="card-title mt-3">{{$lot['nombre']}}</h5>
                        <p class="card-title mt-3 small">{{$lot['desc']}}</p>
                        <p class="card-title mt-3 small">Beer leftover: @if($lot['cantidad'] != 0){{$lot['cantidad']}}
                            @else
                            <div class="col-12">
                                <h2>
